...
// notifica por correo al huésped (en su idioma), al anfitrión y al
// co-anfitrión (en español).
//
...
const { fetchTRM } = require("./_trm");
const { cancellationEmail, guideFooter } = require("./_emailTemplates");

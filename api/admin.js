...
// photosList, photosUpload, photosDelete, photosReorder.
...
const { uploadPhoto, deletePhoto, publicUrl } = require("../lib/_storage");
...
module.exports = async (req, res) => {
  ...
  try {
    switch (action) {
      ...
      case "photosList": return await handlePhotosList(req, res);
      case "photosUpload": return await handlePhotosUpload(req, res);
      case "photosDelete": return await handlePhotosDelete(req, res);
      case "photosReorder": return await handlePhotosReorder(req, res);
      default:
...
/* ============================================================
   ...
   ============================================================ */
async function handlePhotosList(req, res) {
...
async function handlePhotosUpload(req, res) {
...
async function handlePhotosDelete(req, res) {
  const { id } = req.body || {};
  if (!id) {
...
async function handlePhotosReorder(req, res) {

...
5. Sube a GitHub los archivos nuevos: `_storage.js`, `admin-photos-list.js`,
   `admin-photos-upload.js`, `admin-photos-delete.js`,
   `admin-photos-reorder.js`, `photos-public.js`
